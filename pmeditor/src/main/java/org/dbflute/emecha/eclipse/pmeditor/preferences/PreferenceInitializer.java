...
public class PreferenceInitializer extends AbstractPreferenceInitializer {
    ...
    public void initializeDefaultPreferences() {
        IPreferenceStore store = PMEditorActivator.getDefault().getPreferenceStore();
        ...
        store.setValue("insert.single.proposals.auto", true);

        for (TextAttributeDefinition color : PmColorDef.values()) {
            String foreground;
